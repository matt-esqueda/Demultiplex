...
def oneline_fasta(file):
    ...
    output_file = ""
    with open('new_fasta.fa', 'w') as out:                                    
...
if __name__ == "__main__":
    ...
    assert reverse_complement('GCTA') == 'TAGC', "reverse complement does not return the correct sequence"
    assert reverse_complement('AACCTTGG') == 'CCAAGGTT', "reverse complement does not return the correct sequence"
    print("Passes reverse complement test")
